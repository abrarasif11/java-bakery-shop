        ...
        <div class="flex font-titillium flex-col items-center justify-center w-full max-w-sm mx-auto">
            ...
            <div class="w-56 -mt-10 overflow-hidden rounded-lg shadow-lg md:w-64 bg-red-700">
                ...
                <div class="flex items-center justify-between px-3 py-2 bg-black">
                    <button onClick={() => handleOneCategory(`${category.category_id}`)} className="px-2 py-1 text-xs font-semibold text-white transition-colors duration-300 transform bg-red-700 rounded hover:bg-gray-700 dark:hover:bg-gray-600 focus:bg-gray-700 dark:focus:bg-gray-600 focus:outline-none">Order Now</button> 
                </div>
            </div>
        </div>
    );
