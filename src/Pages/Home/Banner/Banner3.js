...
const Banner3 = () => {
    return (
        <section className="p-4 lg:p-8 mt-20 dark:text-gray-100">
            <div className="container mx-auto space-y-12">
                <div className="flex flex-col font-titillium overflow-hidden rounded-md shadow-sm lg:flex-row">
                    ...
                    <div className="flex flex-col justify-center flex-1 p-6 bg-black">
                        <h3 className="text-3xl text-red-700 font-bold">We Always Try Happy Our Customer</h3>
