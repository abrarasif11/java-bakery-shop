    ...
    return (
        <div class="w-full font-titillium max-w-sm p-6 m-auto mx-auto mt-20 bg-gray-500 rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="flex items-center mt-6 -mx-2">
                <button onClick={handleGoogleSignIn} type="button" class="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:bg-blue-400 focus:outline-none">
